...
public class PaymentDaoImpl extends GenericAbstractDao<Payment> implements IPaymentDao {
    ...
    @Override
    public List<Payment> findAllPayments() throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException {
        List<Payment> payments = findAll(Payment.class, SQL_selectAll);
        return payments;
    }

    @Override
    public List<Payment> findAllPaymentsByOrderCode(Long orderCode) throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException  {
        List<Payment> payments = findAll(Payment.class, SQL_selectAll);
    ...
    @Override
    public Payment findPaymentById(Integer id) throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException  {
        Payment payment = findBy(Payment.class, SQL_selectById, id);
        return payment;
    }

    @Override
    public boolean addPaymentToDB(Payment payment) throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException  {
        return false;
    }

    @Override
    public boolean updatePaymentInDB(Payment payment) throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException  {
        return false;
    }

    @Override
    public boolean deletePaymentFromDB(Payment payment) throws IncorrectPropertyException, DataBaseConnectionException, DataNotFoundException  {
        return false;
    }
}
